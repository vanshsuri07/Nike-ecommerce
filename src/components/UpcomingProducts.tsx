  ...
  return (
    <section className="py-12 sm:py-16 bg-gray-900 text-white">
      <div className="container mx-auto px-4">
        <div className="relative grid grid-cols-1 md:grid-cols-2 items-center gap-8 bg-gray-800 rounded-xl shadow-2xl overflow-hidden min-h-[400px] md:min-h-[300px]">
          {/* Background Glow */}
          ...
          {/* Text */}
          <motion.div
            className="p-6 md:p-10 z-10 relative text-center md:text-left"
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mt-2 mb-4 leading-tight">
              The Future of Speed
            </h2>
            <p className="text-gray-300 mb-6 text-base md:text-lg">
              Unveiling a new era of performance. This exclusive drop is engineered for the ultimate athlete.
            </p>
            <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-8 rounded-full transition-transform hover:scale-105 text-base">
              Get Notified
            </button>
          </motion.div>
          ...
          {/* Image */}
          <motion.div
            className="relative h-64 md:h-[320px] w-full flex justify-center items-center z-10"
